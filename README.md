...
- **Processor:** *Will only make the simulation longer*
- **RAM:** *RAM utilization will depend on the model complexity, quantity of operations and investments*   
- **SpineOpt:** *Required*
...
- **output.json:** A .json file will be generated by the python pipeline. This .json can then be read by the Importer directly in a Spine DB once SpineOpt is installed.
